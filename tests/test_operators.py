...
class TestOperators(unittest.TestCase):
    ...
    # def test_callable_matvec_pow_ell_alm_sqrt(self):
    ...
    #     matvec = operators.callable_matvec_pow_ell_alm(ainfo, icov, 0.5, inplace=False)

    #     np.testing.assert_array_almost_equal(matvec(alm), alm_exp)

    # def test_callable_matvec_pow_pix_alm_sqrt(self):
    ...
    #     alm_exp = alm.copy()
    #     matvec = operators.callable_matvec_pow_pix_alm(
    #         ainfo, icov, minfo, spin, power, inplace=False)
...
##
    ...
    # def test_matvec_pow_ell_alm(self):
    ...
    #     alm_exp[1] *= 4
    #     alm_exp[2] *= 9
    #     alm_out = operators.matvec_pow_ell_alm(alm, ainfo, icov, 1, inplace=False)

    #     np.testing.assert_array_almost_equal(alm_out, alm_exp)

    # def test_matvec_pow_ell_alm_sqrt(self):
    ...
    #     alm_exp[1] *= np.sqrt(4)
    #     alm_exp[2] *= np.sqrt(9)
    #     alm_out = operators.matvec_pow_ell_alm(alm, ainfo, icov, 0.5, inplace=False)
    ...
    #     alm_exp[1] *= np.sqrt(4)
    #     alm_exp[2] *= np.sqrt(9)
    #     alm_out = operators.matvec_pow_ell_alm(alm, ainfo, icov, 0.5, inplace=True)
