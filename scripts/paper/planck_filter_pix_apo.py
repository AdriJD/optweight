...
def main(basedir, draw_constr=False, test_conv=False, niter_cg=20, niter_mg=40,
    ...
    mask_I[mask_I>=0.01] = 1
    mask_I[mask_I<0.01] = 0
    ...
    if apod_icov:
        mask_I_apo[mask_I_apo < 0.01] = 0
        mask_P_apo[mask_P_apo < 0.01] = 0        
        
        mask_I_apo[mask_I_apo < 0.01] = 0.01 # 0.05 works much better.
        mask_P_apo[mask_P_apo < 0.05] = 0.05
